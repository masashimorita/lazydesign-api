...
ActiveRecord::Schema.define(version: 2019_12_15_095044) do
  ...
  create_table "projects", primary_key: "project_id", id: :binary, limit: 128, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["deploy_method_id"], name: "fk_rails_2a93e25945"
  ...
  add_foreign_key "projects", "deploy_methods", primary_key: "deploy_method_id"
