...
ActiveRecord::Schema.define(version: 2019_11_29_140015) do
  ...
  create_table "deploy_methods", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
